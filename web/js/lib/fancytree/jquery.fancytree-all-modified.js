...
//		this.debug("_hook", funcName, ctx.node && ctx.node.toString() || ctx.tree.toString(), args);
   ...
   */
   /** Return the number of child nodes. */
	 ...
	 */
	generateFormElements: function(selected, active, inputname) {
		// TODO: test case
		var nodeList,
			selectedName = (selected !== false) ? inputname : selected,
			activeName = (active !== false) ? inputname : active,
...
//			that = this;
		...
		$children.each(function() {
			...
			if( $liSpan.length ) {
				...
				d.data.image = $liA.attr("data-image");
